...
public class DownloadJumpLogic {

	// 获取文件列表并返回下载页
	public String downloadJumpMethod(HttpServletRequest request, HttpServletResponse resp) {

		// 获取上传文件的目录
		String uploadFilePath = "D:\\JAVA\\workspace\\javaWebTest\\WebContent\\upload";
		// 存储要下载的文件名
	...
	/**
	 * listfile 递归遍历指定目录下的所有文件 file 即代表一个文件，也代表一个文件目录 map 存储文件名的Map集合
	 */
